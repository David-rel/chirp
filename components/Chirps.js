        ...
        <div class="flex flex-shrink-0 p-4 pb-0">
            ...
            <div class="pl-16">
                <p class="text-base width-auto font-medium text-white flex-shrink">
                  Week 1 of coding Twitter clone: Chirp 
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex items-center">
                            <div class="flex-1 text-center">
                                <a href="#" class="w-12 mt-1 group flex items-center text-gray-500 px-3 py-2 text-base leading-6 font-medium rounded-full hover:bg-green-800 hover:text-green-300">
