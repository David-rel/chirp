...
const Home = () => {
  ...
  }, [user]); // This will only run when 'user' changes
  ...
  return (
    <>
      <div className="items-center bg-black">
        <h1 className="grid place-items-center bg-green-600">
          Welcome to Chirp
        </h1>
        <br />
        <h2 className="grid place-items-center text-green-500">
          A new Twitter Clone
          <svg
            viewBox="0 0 24 24"
        ...
        <br />
        <div class="relative max-w-md mx-auto md:max-w-2xl mt-6 min-w-0 break-words bg-black w-full mb-6 shadow-lg rounded-xl mt-16">
          <div class="px-6">
              ...
              <div class="flex flex-wrap justify-center">
                <div class="w-full px-4">
                  <p class="font-light leading-relaxed text-slate-600 mb-4">
                    I am a 17 year old web dev who loves to create full stack
                    websites of any kind. I created this project to challenge my
                    ability and to see how far I could go in just one website
                    using my knowledge. I role out new updates every week. I
                    built this in next.js, tailwindcss, and supabase. Hope you
                    like it.
                  </p>
                </div>
              </div>
